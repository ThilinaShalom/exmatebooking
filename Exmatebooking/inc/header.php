<!--nav bar-->
 <nav class="navbar navbar-expand-lg navbar-light bg-white px-lg-3 py-lg-2 shadow-sm sticky-top">
  <div class="container-fluid">
    <a class="navbar-brand me-5 fw-bold fs-3 h-font" href="home.php">ExMateBooking.</a>
...
<div class="modal fade" id="registerModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <span class="badge bg-light text-dark mb-3 text-wrap lh-base">NOTE: Your detais must match with your ID (Driving license, National ID, Passport) 
        ...
        <div class="container-fluid">
          ...
          <div class="text-center my-1">
            <button type="submit" class="btn btn-dark shadow-none">Sing Up</button>
          </div>
